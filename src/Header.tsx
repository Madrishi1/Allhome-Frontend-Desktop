...
const Header: React.FC<HeaderProps> = ({ title }) => {
  ...
  return (
    <div>
    <div className="bg-[#323031] text-white py-2 border border-[#645f5fa1] cursor-pointer">
            <div className="max-w-7xl mx-auto px-4 flex justify-between items-center">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <svg className="w-3 h-3  mt-1 mx-1 text-white-800  dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
