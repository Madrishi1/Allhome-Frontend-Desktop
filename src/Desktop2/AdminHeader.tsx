...
type AdminHeaderProps = {
  ...
  const AdminHeader: React.FC<AdminHeaderProps> = ({ title }) => {
    return (
       <header className="flex justify-between max-w-7xl mx-auto space-x-8 bg-white p-2">
        ...
        <span className='flex flex-row order-last space-x-5 px-7'>
            <div className="  flex flex-col relative rounded-full">
                <span className=" rounded-full text-base font-bold">Administrator</span>
